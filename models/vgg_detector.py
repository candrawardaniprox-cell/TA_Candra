...
class VGGDetector(BaseDetector):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # ---- Block4 dan Block5 dihapus untuk memangkas ~12 juta parameter total ----
        # Diganti dengan MaxPool agar ukurannya (stride) tetap sesuai untuk FPN
        self.stage_p4 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.stage_p5 = nn.MaxPool2d(kernel_size=2, stride=2)


        # ---- FPN + Detection Head ----
        self._build_fpn_and_head(
            c2_ch=128, c3_ch=256, c4_ch=256, c5_ch=256,
