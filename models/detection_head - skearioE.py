...
class AnchorFreeDetectionHead(nn.Module):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.cls_logits = nn.Conv2d(in_channels, num_classes, kernel_size=1, padding=0)
        ...
        self.bbox_reg = nn.Conv2d(in_channels, 4, kernel_size=1, padding=0)
        
        # 3. Cabang Centerness (Memastikan tebakan di tengah objek nilainya lebih tinggi)
        self.centerness = nn.Conv2d(in_channels, 1, kernel_size=1, padding=0) 
