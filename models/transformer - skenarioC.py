...
class CPSA(nn.Module):
    ...
    def __init__(self, dim: int, num_heads: int = 4, reduction_ratio: int = 2):
        ...
        # --- KODE ASLI DIPAGAR UNTUK SKENARIO C ---
        ...
        # KV projection (sekarang memproyeksikan dari x asli, bukan dari S)
    ...
    def forward(self, x: torch.Tensor, H: int, W: int) -> torch.Tensor:
        ...
        # --- KODE BARU UNTUK SKENARIO C ---
        # K dan V diambil langsung dari 'x' (tanpa disaring CNN), panjang sekuens tetap 'N' bukan 'M'
        kv = self.kv_proj(x)
